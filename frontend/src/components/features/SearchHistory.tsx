 ...
 */
export default function SearchHistory({ onHistoryItemClick }: SearchHistoryProps) {
    ...
    <div className="space-y-3">
        ...
        >
          <div className="flex items-center space-x-3">
            <div className="flex-shrink-0 w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-blue-50 transition-colors duration-200 dark:bg-gray-700 dark:group-hover:bg-blue-900/20">
              <svg className="w-4 h-4 text-gray-500 group-hover:text-blue-500 transition-colors duration-200 dark:text-gray-400 dark:group-hover:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-0.5 dark:text-gray-400">Click to search again</p>
            </div>
      ...
      {items.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Your searches will appear here</p>
        </div>
      )}
    </div>
  );
