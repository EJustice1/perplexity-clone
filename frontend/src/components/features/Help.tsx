  ...
  const faqData = [
    {
      ...
      content:
        "Simply type your question in the search bar and press Enter or click the search button. The AI will process your query and provide relevant answers.",
    },
    {
      category: "general",
      title: "What types of questions can I ask?",
      content:
        "You can ask questions about any topic - from technical programming questions to general knowledge, academic research, or creative writing help.",
    },
    {
      category: "account",
      title: "How do I create an account?",
      content:
        'Click the "Log In" button in the sidebar and then select "Create Account" to sign up for a new account.',
    },
    {
      category: "account",
      title: "Can I use the service without an account?",
      content:
        "Yes, you can use basic search functionality as a guest user, but creating an account gives you access to search history and additional features.",
    },
    {
      category: "technical",
    ...
    },
    {
      ...
      content:
        "Yes, we take data security seriously. All communications are encrypted, and we never store your personal information without consent.",
    },
  ];
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
              onClick={() =>
                toast("Documentation will be available in the next phase!")
              }
            ...
            <button
              onClick={() =>
                toast("Video tutorials will be available in the next phase!")
              }
              className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
              <div className="flex items-center space-x-3">
            ...
            <button
              onClick={() =>
                toast("Community forum will be available in the next phase!")
              }
              className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
              <div className="flex items-center space-x-3">
            ...
            <button
              onClick={() =>
                toast("Live chat will be available in the next phase!")
              }
              className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
              <div className="flex items-center space-x-3">
