...
export default function UserProfile({ variant = 'sidebar' }: UserProfileProps) {
  ...
  if (isLoggedIn) {
    return (
      <div className={`flex items-center space-x-3 ${isMobile ? 'pb-4 border-b border-gray-200 dark:border-gray-700' : ''}`}>
        ...
        <button
          ...
          className="text-sm text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 font-medium transition-colors duration-200"
        >
          Log Out
        </button>
      </div>
