 ...
 */
export default function ThemeToggleWrapper({ variant = 'sidebar' }: ThemeToggleWrapperProps) {
  ...
  if (!mounted) {
    ...
    return (
      <div className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg w-full ${
        variant === 'sidebar' 
