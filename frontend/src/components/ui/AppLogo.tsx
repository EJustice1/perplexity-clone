...
export default function AppLogo({
  ...
  return (
    <div
      className={`flex items-center space-x-3 ${isSidebar ? "justify-center" : ""}`}
    >
      {/* Logo Icon */}
      <div
      ...
      >
        <span
          className={`text-white font-bold ${isSidebar ? "text-xl" : "text-lg"}`}
        >
          P
        </span>
      </div>
      ...
      <div className={isSidebar ? "text-center" : ""}>
        <h1
          className={`font-semibold text-gray-900 dark:text-white ${isSidebar ? "text-xl" : "text-lg"}`}
        >
          Perplexity Clone
        </h1>
