...
from .providers.gemini_2_0_flash_lite_provider import Gemini2FlashLiteProvider
    ...
    def _initialize_provider(self):
        ...
        try:
            ...
            if api_key:
                ...
                logger.info("Query enhancement provider initialized successfully")
            else:
                logger.warning("No GOOGLE_AI_API_KEY environment variable found, query enhancement disabled")
        except Exception as e:
            logger.error(f"Failed to initialize query enhancement provider: {str(e)}")
    
    async def enhance_query(self, original_query: str) -> QueryEnhancementResponse:
        """
        ...
        try:
            ...
            if response.success:
                ...
                logger.warning(f"Query enhancement failed: {response.error_message}")
...
def get_query_enhancement_service() -> QueryEnhancementService:
    """Get the global query enhancement service instance."""
